...
class OfflineRegionDefinition {
  const OfflineRegionDefinition({
    ...
    required this.vectorSourceProperties,
  });
  ...
  final VectorSourceProperties vectorSourceProperties;

  @override
  String toString() =>
      "$runtimeType, bounds = $bounds, mapStyleUrl = $mapStyleUrl, minZoom = $minZoom, maxZoom = $maxZoom ,vectorSourceProperties=$vectorSourceProperties";
