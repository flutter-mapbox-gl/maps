    ...
    switch (call.method) {
      ...
      case "offline#downloadOnClick":
        ...
        if(regionName.length()==0){
          double centerLat = mapboxMap.getProjection().getVisibleRegion().latLngBounds.getCenter().getLatitude();
          double centerLng = mapboxMap.getProjection().getVisibleRegion().latLngBounds.getCenter().getLongitude();
