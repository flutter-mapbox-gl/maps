...
import com.mapbox.mapboxgl.utils.AccesToken;
 ...
 */
public final class MapboxMapController implements Application.ActivityLifecycleCallbacks, MapboxMap.OnCameraIdleListener,
  MapboxMap.OnCameraMoveListener, MapboxMap.OnCameraMoveStartedListener, MapboxMapOptionsSink,
  MethodChannel.MethodCallHandler, OnMapReadyCallback, PlatformView {

  public static final String TAG = "MapboxMapController";
  ...
  MapboxMapController(int id, Context context, AtomicInteger activityState,
                      PluginRegistry.Registrar registrar, MapboxMapOptions options) {
    Mapbox.getInstance(context, AccesToken.getAccessToken(context));
    this.id = id;
  ...
  void init() {
    switch (activityState.get()) {
      ...
      case CREATED:
        ...
        break;
      case DESTROYED:
        // use MapboxMapController#dispose instead
        break;
      default:
