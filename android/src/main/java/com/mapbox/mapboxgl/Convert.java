...
//  }
    ...
    static void interpretMapboxMapOptions(Object o, MapboxMapOptionsSink sink) {
        ...
        final Object trafficPluginEnabled = data.get("trafficPluginEnabled");
        if (trafficPluginEnabled != null) {
            sink.setTrafficPluginEnabled(toBoolean(trafficPluginEnabled));
        }
